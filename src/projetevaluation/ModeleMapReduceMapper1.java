 ...
 * @author hadoop
 */
public class ModeleMapReduceMapper1 extends Mapper<LongWritable, Text, Text, DoubleWritable>{
     // allocation mémoire de la clé et valeur de sortie
    private Text cleC = new Text();
    private DoubleWritable valeurC= new DoubleWritable();
            ...
            throws IOException, InterruptedException
    {
        ...
        try {
           ...
           Sales sale = new Sales(ligne);
            cleC.set(new Text(""+sale.getCountry()+""));
            valeurC.set(sale.getTotalProfit());
            // émettre la paire (clé, valeur) vers le reducer
            context.write(cleC, valeurC);
